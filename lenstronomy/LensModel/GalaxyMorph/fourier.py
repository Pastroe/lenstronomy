...
class Fourier(LensProfileBase):
    """
    class to compute the Fourier mode of spiral arms.
    """
    ...
    def mapping(self, x, y, m_1, m_3, m_4, m_5, m_6, phi_1, phi_3, phi_4, phi_5, phi_6, center_x=0, center_y=0):
        ...
        :param m_k: the strength of m_k*cos(k φ) component
        :param phi_i: the phase angle of m_k*cos(k φ) component
    ...
    def reverse_mapping(self, x, y, m_1, m_3, m_4, m_5, m_6, phi_1, phi_3, phi_4, phi_5, phi_6, center_x=0, center_y=0):
        """
